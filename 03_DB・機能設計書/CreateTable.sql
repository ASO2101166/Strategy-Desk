...
(board_id               INT, --掲示板ID
 ...
 parent_comment_id      INT NOT NULL, --親コメントID
 user_id                INT NOT NULL, --会員番号
...
(map_parts_id           INT, --マップ部品ID
 map_parts_image        BLOB NOT NULL, --マップ部品画像
...
(questionary_id         INT, --アンケートID
 ...
 questionary_detail     VARCHAR(255) NOT NULL,
 questionary_votes      INT NOT NULL DEFAULT 0,
